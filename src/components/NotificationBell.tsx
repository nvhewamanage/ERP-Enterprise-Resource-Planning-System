...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        onClick={() => setOpen((v) => !v)}
        className="relative rounded-lg border border-black/[.1] p-2 text-zinc-600 transition-colors hover:bg-zinc-100 dark:border-white/[.15] dark:text-zinc-300 dark:hover:bg-zinc-900"
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-2 w-80 rounded-lg border border-zinc-200 bg-white shadow-lg dark:border-white/[.1] dark:bg-zinc-950">
          <div className="flex items-center justify-between border-b border-zinc-100 px-4 py-2 dark:border-white/[.08]">
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((n) => (
                <button
                  ...
                  className={`block w-full border-b border-zinc-50 px-4 py-3 text-left text-sm last:border-0 hover:bg-zinc-50 dark:border-white/[.05] dark:hover:bg-zinc-900 ${
